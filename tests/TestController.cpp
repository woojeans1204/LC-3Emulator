...
int main()
{
    ...
    std::string sourceFilePath = "tests/sample/input.asm"; // array.asm, blur.asm, stack.asm을 Input.asm에 복사해 테스트
    std::string objFilePath = "tests/sample/test.obj";
    ...
    controller.assembleRun(sourceFilePath, objFilePath);
